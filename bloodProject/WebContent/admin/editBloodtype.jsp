...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div id="base">
		...
		<div class="section-body contain-lg">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="text-primary">Edit Bloodtype</h1>
				</div><!--end .col -->
			...
			<c:forEach items="${sessionScope.editList}" var="e">
				<form class="form form-validate floating-label"  action="<%=request.getContextPath() %>/BloodtypeController" method="post">
						<input type="hidden" class="form-control" name="flag" value="update">
						
						
						<div class="card">
							<input type="hidden" class="form-control" name="bloodtypeId" value="${e.bloodtypeId}">
							<div class="card-body">
							
							
								<div class="form-group">
									<input type="text" class="form-control" value="${s.bloodType}" id="Name1" name="bloodType">
									<label for="Name1">Blood Type</label>
								</div>
								
								
								
								<div class="form-group">
									<textarea name="bloodtypeDescription" id="textarea1" class="form-control" rows="3" >${e.bloodtypeDescription}</textarea>
									<label for="textarea1">Bloodtype Description</label>
								</div>
