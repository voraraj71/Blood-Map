								...
								<table id="datatable1" class="table table-striped table-hover">
									...
									<tbody>
										<tr class="gradeX">
											<td>${s.cityId}</td>
											<td>${s.cityName}</td>
											<td>${s.cityDescription}</td>
											<td>${s.stateVO.stateName}</td>
											<td><a href ="<%=request.getContextPath()%>/CityController?flag=edit&id=${s.cityId}">Edit</a>
											<a href ="<%=request.getContextPath()%>/CityController?flag=delete&id=${s.cityId}">Delete</a>
