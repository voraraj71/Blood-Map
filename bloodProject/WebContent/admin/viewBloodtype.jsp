								...
								<table id="datatable1" class="table table-striped table-hover">
									...
									<tbody>
										<tr class="gradeX">
											<td>${s.bloodtypeId}</td>
											<td>${s.bloodType}</td>
											<td>${s.bloodtypeDescription}</td>
											<td>
											<a href ="<%=request.getContextPath()%>/BloodtypeController?flag=edit&id=${s.bloodtypeId}">Edit</a>
											<a href ="<%=request.getContextPath()%>/BloodtypeController?flag=delete&id=${s.bloodtypeId}">Delete</a>
