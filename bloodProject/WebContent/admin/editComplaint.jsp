...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div id="base">
		...
		<div class="section-body contain-lg">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="text-primary">Edit Complaint</h1>
				</div><!--end .col -->
			...
			<c:forEach items="${sessionScope.editList}" var="e">
				<form class="form form-validate floating-label"  action="<%=request.getContextPath() %>/ComplaintController" method="post">
						<input type="hidden" class="form-control" name="flag" value="reply">
						
							<input type="hidden" name="complaintId" value="${e.complaintId}">
						
						<input type="hidden" name="complaintFrom" value="${e.loginVOTo.loginId}">
						<input type="hidden" name="complaintTo" value="${e.loginVOFrom.loginId}">
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group">
									<input type="text" class="form-control" id="Name1" name="title" value="${e.title}">
									<label for="Name1">Title</label>
								</div>
								<div class="form-group">
									<textarea name="complaint" id="textarea1" class="form-control" rows="3" >${e.complaint}</textarea>
									<label for="textarea1">Complaint</label>
								</div>
								
								<div class="form-group">
									<textarea name="reply" id="textarea1" class="form-control" rows="3" ></textarea>
