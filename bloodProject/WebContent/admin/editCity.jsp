...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div id="base">
		...
		<div class="section-body contain-lg">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="text-primary">Edit City</h1>
				</div><!--end .col -->
			...
			<form class="form form-validate floating-label" action="<%=request.getContextPath() %>/CityController" method="post">
			<input type="hidden" name="flag" value="update">
			<div class="card">
			<input type="hidden" name="cityId" value="${e.cityId}">
				<div class="card-body">
					<div class="form-group">
									<select class="form-control" id="Name1" name="stateName">
									<c:forEach items="${sessionScope.searchList}" var="s">
										<c:if test="${s.stateId ne e.stateVO.stateId}">
										<option value="${s.stateId}" selected="selected">${s.stateName}</option>
										</c:if>
									</c:forEach>
									<option value="${e.stateVO.stateId}">${e.stateVO.stateName}</option>
									</select>
								...
								<div class="form-group">
									<input type="text" class="form-control" id="Name1" name="cityName" value="${e.cityName}">
									<label for="City Name">City Name</label>
								</div>
								
								<div class="form-group">
									<textarea name="cityDescription" id="textarea1" class="form-control" rows="3" >${e.cityDescription}</textarea>
