								...
								<table id="datatable1" class="table table-striped table-hover">
									...
									<tbody>
										<tr class="gradeX">
											...
											<td>${s.title}</td>
											<td>${s.complaint}</td>
											<%-- <td>${s.complaintDate}</td>
											<td>${s.complaintTime}</td>
											<td>${s.complaintStatus}</td>
											<td>${s.loginVOFrom}</td>
											 --%>
											<td><a href="<%=request.getContextPath()%>/ComplaintController?flag=edit&id=${s.complaintId}">Reply</a></td>
										</tr>
