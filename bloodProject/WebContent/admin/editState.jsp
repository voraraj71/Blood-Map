...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div id="base">
		...
		<div class="section-body contain-lg">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="text-primary">Edit State</h1>
				</div><!--end .col -->
				<div class="col-lg-3 col-md-4">
					
				</div><!--end .col -->
				<div class="col-lg-offset-1 col-md-8">
			<c:forEach items="${sessionScope.editList}" var="e">
				<form class="form form-validate floating-label"  action="<%=request.getContextPath() %>/StateController" method="post">
						<input type="hidden" class="form-control" name="flag" value="update">
						
						
						<div class="card">
							<input type="hidden" class="form-control" name="stateId" value="${e.stateId}">
							<div class="card-body">
						
								<div class="form-group">
									<input type="hidden" class="form-control" id="Name1" name="stateId" value="${e.stateId}">
									<label for="Name1">State Id</label>
								</div>
							
								<div class="form-group">
									<input type="text" class="form-control" id="Name1" name="stateName" value="${e.stateName}">
									<label for="Name1">State Name</label>
								</div>
								<div class="form-group">
									<textarea name="stateDescription" id="textarea1" class="form-control" rows="3" >${e.stateDescription}</textarea>
									<label for="textarea1">State Description</label>
								</div>
