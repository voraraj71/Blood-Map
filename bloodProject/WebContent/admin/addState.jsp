...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div id="base">
		...
		<div class="section-body contain-lg">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="text-primary">Add State</h1>
				</div><!--end .col -->
						...
						<div class="card">
							<div class="card-body">
								<div class="form-group">
									<input type="text" class="form-control" id="Name1" name="stateName">
									<label for="Name1">State Name</label>
								</div>
								<div class="form-group">
									<textarea name="stateDescription" id="textarea1" class="form-control" rows="3" ></textarea>
