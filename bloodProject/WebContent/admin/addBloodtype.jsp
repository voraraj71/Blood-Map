...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div id="base">
		...
		<div class="section-body contain-lg">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="text-primary">Add Bloodtype</h1>
				</div><!--end .col -->
						...
						<div class="card">
							<div class="card-body">
								<div class="form-group">
									<input type="text" class="form-control" id="Name1" name="bloodType">
									<label for="Name1">Blood Type</label>
								</div>
								<div class="form-group">
									<textarea name="bloodtypeDescription" id="textarea1" class="form-control" rows="3" ></textarea>
									<label for="textarea1">Blood Type Description</label>
								</div>
								<div class="form-group">
