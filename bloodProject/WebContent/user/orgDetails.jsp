...
<article id="post-407" class="post_item_single post_type_donation post-407 donation type-donation status-publish has-post-thumbnail hentry donation_category-second-group">
<div class="post_sidebar">
<!-- <div class="post_featured" style="height: 25%;width: 40%"> -->
<div><img width="320" height="150" src="image/org.jpg" class="attachment-thumb_med size-thumb_med wp-post-image" alt="organisation image"/> </div> 
...
<div class="post_supporters_count">No supporters yet</div>
 ...
 <c:forEach items="${sessionScope.orgList}" var="i">
<div class="post_body">
<div class="post_header entry-header">
<h1 class="post_title entry-title">${i.orgname}</h1> <!-- <div class="post_info"></div> -->
<span>Contact No: ${i.contactno}</span><br>
<span>E-mail: ${i.email}</span><br>
<span>Address: ${i.address}</span><br>
<span>State: ${i.stateVO.stateName}</span><br>
<span>City: ${i.cityVO.cityName}</span>
