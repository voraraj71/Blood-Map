...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div id="base">
		...
		<div class="section-body contain-lg">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="text-primary">Edit Availability</h1>
				</div><!--end .col -->
					...
					<div class="form-group">
							<select class="form-control" id="Name1" name="bloodType">
								...
								<c:forEach items="${sessionScope.searchList}" var="s">
									...
									<c:if test="${s.bloodtypeId ne e.bloodtypeVO.bloodtypeId}">
									<option value="${s.bloodtypeId}">${s.bloodType}</option>
									</c:if>

								</c:forEach> 
								
								<option value="${e.bloodtypeVO.bloodtypeId}" selected="selected">${e.bloodtypeVO.bloodType}</option>				
							</select>
									<label for="State Name">Bloodtype</label>
								</div>
				
								
								<div class="form-group">
									<textarea name="amount" id="textarea1" class="form-control" rows="3" >${e.amount}</textarea>
