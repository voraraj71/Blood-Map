...
<html lang="en">
			...
			xmlhttp.onreadystatechange = function() {
				if (xmlhttp.readyState == 4) 
				{
					...
					for(i=0 ; i<jsonObj.length ; i++)
					{
						...
						document.event.city.options.add(createOption);
	...
	function removeAllState()
	{
		...
		var removeState=document.event.city.options.length;
		for(i=removeState ; i>0 ; i-- )
		{
			document.event.city.remove(i);
		}
	}
		...
		<div class="section-body contain-lg">
			...
			<div class="row">
				...
				<div class="col-lg-offset-1 col-md-8">
										<form class="form form-validate floating-label" name="event"  action="<%=request.getContextPath()%>/EventController" method="post">
						<input type="hidden" class="form-control" name="flag" value="insert">
						<div class="card">
							<div class="card-body">
							
								<div class="form-group">
									<input type="text" class="form-control" id="Name1" name="eventName">
									<label for="Name1">Event Name</label>
								</div>
								
								<div class="form-group">
									<select onchange="load()" class="form-control" id="state" name="stateName">
									...
									<label for="Name1">State Name</label>
								</div>
							
							<div class="form-group">
									<select  class="form-control" id="Name1" name="city">
								...
								<div class="form-group">
									<textarea name="address" id="textarea1" class="form-control" rows="3" ></textarea>
									<label for="textarea1">Address</label>
									
									<div class="form-group">
									<input type="date" class="form-control" id="Name1" name="eDate">
									<label for="Name1">Date</label>
								</div>
								
								<div class="form-group">
									<input type="text" class="form-control" id="Name1" name="eTime">
									<label for="Name1">Time</label>
								</div>
								
								</div>
								<div class="form-group">
									<textarea name="eventDescription" id="textarea1" class="form-control" rows="3" ></textarea>
							...
							<div class="card-actionbar">
								<div class="card-actionbar-row">
									<button type="submit" class="btn btn-flat btn-primary ink-reaction">Add Event</button>
								</div>
