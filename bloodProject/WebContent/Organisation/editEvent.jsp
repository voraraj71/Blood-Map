	...
	<div id="base">
		...
		<div class="section-body contain-lg">
			...
			<div class="row">
				...
				<c:forEach items="${sessionScope.editEventList}" var="e">
							
										<form class="form form-validate floating-label"  action="<%=request.getContextPath() %>/EventController" method="post">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group">
									<input type="text" class="form-control" id="Name1" name="eventName" value="${e.eventName}" required data-rule-minlength="2">
									<label for="City Name">Event Name</label>
								</div>
								<div class="form-group">
									<textarea name="eventDescription" id="textarea1" class="form-control" rows="3">${e.eventDescription}</textarea>
									<label for="textarea1">Event Description</label>
								</div>
								
								<div class="form-group">
									<select class="form-control" id="Name1" name="stateName">
									<c:forEach items="${sessionScope.editstateList}" var="p">
								...
								<div class="form-group">
									<select class="form-control" id="Name1" name="cityName">
									<c:forEach items="${sessionScope.editCityList}" var="s">
									<option value="${s.cityId}">${s.cityName}</option>
									
									</c:forEach>
									</select>
									<label for="State Name">city Name</label>
								</div>
								
								<div class="form-group">
									<textarea name="address" id="textarea1" class="form-control" rows="3">${e.address}</textarea>
									<label for="textarea1">Address</label>
								</div>
								<div class="form-group">
									<input type="text" class="form-control" id="Name1" value="${e.eDate}" name="eDate" required data-rule-minlength="2">
									<label for="City Name">Date</label>
								</div>
								<div class="form-group">
									<input type="text" class="form-control" id="Name1"  value="${e.eTime}" name="eTime" required data-rule-minlength="2">
									<label for="City Name">Time</label>
								</div>
