...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div id="base">
		...
		<div class="section-body contain-lg">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="text-primary">Add Availability</h1>
				</div><!--end .col -->
				<div class="col-lg-3 col-md-4">
					
				</div><!--end .col -->
				<div class="col-lg-offset-1 col-md-8">
										<form class="form form-validate floating-label" action="<%=request.getContextPath()%>/AvailabilityController" method="post">
						<div class="card">
							<div class="card-body">
							
					
								<div class="form-group">
									<select  class="form-control" id="Name1" name="bloodType">
										
										<c:forEach items="${sessionScope.searchAvailabilitylist}" var="s">
										<option value="${s.bloodtypeId}">${s.bloodType}</option>					
										</c:forEach>								
									</select>
								
									<label for="Name1">Bloodtype</label>
								</div>
							
								
								<div class="form-group">
									<textarea name="amount" id="textarea1" class="form-control" rows="3"></textarea>
							...
							<div class="card-actionbar">
								<div class="card-actionbar-row">
									<button type="submit" class="btn btn-flat btn-primary ink-reaction">Add Availability</button>
								</div>
