			...
			<div class="menubar-fixed-panel">
				...
				<div class="expanded">
					<a href="http://www.codecovers.eu/materialadmin/dashboards/dashboard">
						<span class="text-lg text-bold text-primary ">Menu</span>
					</a>
				</div>
			</div>
...
<ul id="main-menu" class="gui-controls">
	...
	<li class="gui-folder">
		...
		<!--start submenu -->
		<ul>
			<li><a href="<%=request.getContextPath() %>/EventController?flag=load"><span class="title">Add Event</span></a></li>
			<li><a href="<%=request.getContextPath() %>/EventController?flag=search"><span class="title">View Event</span></a></li>
		</ul><!--end /submenu -->
	</li><!--end /menu-li -->
	<!-- END EMAIL -->
	...
	<li class="gui-folder">
		...
		<ul>
			<li><a href="<%=request.getContextPath()%>/AvailabilityController?flag=loadAvailability"><span class="title">Add Availability</span></a></li>
			<li><a href="<%=request.getContextPath()%>/AvailabilityController?flag=search"><span class="title">View Availability</span></a></li>
