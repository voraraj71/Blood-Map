						...
						<div class="col-lg-12">
							<div class="table-responsive">
								<table id="datatable1" class="table table-striped table-hover">
									...
									<c:forEach items="${sessionScope.searchEventList}" var="s">
									...
									<tbody>
										<tr class="gradeX">
											...
											<td>${s.cityVO.cityName}</td>
											<td>${s.address}</td>
											<td>${s.eDate}</td>
											<td>${s.eTime}</td>
											<td>${s.eventDescription}</td>
											<td><a href ="<%=request.getContextPath()%>/EventController?flag=edit&id=${s.eventId}">Edit</a>
											Delete</td>
